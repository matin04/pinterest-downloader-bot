TEXTS = {
    "tg": {
        "welcome": "Салом, {name}! 👋\n\n✨ Ман боти пешрафтаи боргириҳо аз **Pinterest** ҳастам.\n\n📥 **Чӣ тавр истифода барам?**\nТанҳо линки видео ё суратро аз Pinterest ба ман биристед ва ман онро дар чанд сония бароятон скачат мекунам!",
        "contact_btn": "👨‍💻 Танзимгар / Алоқа",
        "admin_btn": "🛠 Панели Админ",
        "wait": "Лутфан сабр кунед, медиаро омода карда истодаам... ⏳",
        "error_find": "Хаттогӣ: Натавонистам медиаро аз ин линк пайдо кунам. ❌",
    ...
    "ru": {
        ...
        "contact_btn": "👨‍💻 Разработчик / Связь",
        "admin_btn": "🛠 Админ Панель",
        "wait": "Пожалуйста, подождите, готовлю медиа... ⏳",
        "error_find": "Ошибка: Не удалось найти медиа по этой ссылке. ❌",
    ...
    "en": {
        ...
        "contact_btn": "👨‍💻 Developer / Contact",
        "admin_btn": "🛠 Admin Panel",
        "wait": "Please wait, preparing media... ⏳",
        "error_find": "Error: Could not find media from this link. ❌",
